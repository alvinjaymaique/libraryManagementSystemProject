...
namespace LMS
{
    public partial class EditPatronWindow : Window
    {
        ...
        public EditPatronWindow(Patron patron)
        {
            ...
            DateOfBirthTextBox.Text = _patronToEdit.DateOfBirth.ToString();
            ...
            MembershipStatusComboBox.SelectedItem = MembershipStatusComboBox.Items
                .Cast<ComboBoxItem>()
                .FirstOrDefault(item => ((ComboBoxItem)item).Content.ToString() == _patronToEdit.Status);
        }
        ...
        private void Save_Click(object sender, RoutedEventArgs e)
        {
            ...
            if (string.IsNullOrWhiteSpace(FullNameTextBox.Text) ||
                ...
                MembershipStatusComboBox.SelectedItem == null)
            {
            ...
            _patronToEdit.DateOfBirth = DateTime.Parse(DateOfBirthTextBox.Text);
            _patronToEdit.MembershipType = ((ComboBoxItem)MembershipTypeComboBox.SelectedItem).Content.ToString();
            _patronToEdit.Status = ((ComboBoxItem)MembershipStatusComboBox.SelectedItem).Content.ToString();
